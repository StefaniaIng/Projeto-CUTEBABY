...
🚀 Funcionalidades
Inicialização e Monitoramento Contínuo: Ao ligar a placa o display exibe a mensagem "CuteBaby monitorando" enquanto o LED de status permanece aceso, indicando que o sistema está ativo e realizando o monitoramento do ambiente.
Calibração Inteligente: Ajusta o sensor automaticamente ao ruído do ambiente em 5 segundos.
...
Retorno ao Monitoramento: Ao pressionar o botão A o sistema confirma o recebimento do alerta e retorna ao modo de monitoramento contínuo.
...
Link 1: Áudio de Referência (Choro do Bebê) - Clique aqui para acessar o áudio utilizado nos testes - https://youtu.be/Rwj1_eWltJQ?si=7BPPUFgFFxszapKz
...
[ssd1306.c](https://github.com/user-attachments/files/26663901/ssd1306.c)



[Tarefa7.c](https://github.com/user-attachments/files/26663874/Tarefa7.c)
